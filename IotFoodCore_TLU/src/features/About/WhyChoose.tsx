  ...
  return (
    <div>
      <ul style={{listStyleImage:"url(/assets/tick.svg)",padding:" 0 24px 16px 24px"}}>
        <li className="my-4"><b>An toàn</b> - Mọi thanh toán trong Luan Food hiện tại là thanh toán trực tiếp</li>
        <li className="my-4"><b>Nhanh chóng</b> - Bạn chỉ cần đặt và đúng giờ đến nhận &lt;3</li>
        <li className="my-4"><b>Giá rẻ nhất</b> - TluFood hoạt động theo mô hình gom đơn nên giá rẻ hơn với bất kì dịch vụ giao hàng nào</li>
