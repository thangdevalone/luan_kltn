...
const dataQuestion = [
  {
    question: "Luan Food hoạt động như nào?",
    answer:
  ...
  {
    question:
      "Tôi có thể thanh toán trực tuyến trên Luan Food cho đơn hàng của mình không?",
    answer:
      "Chúng tôi chưa hỗ trợ dịch vụ thanh toán trực tuyến trên bản cập nhật lần này",
  },
  {
    question: "Tôi có thể đặt đồ ăn trên Luan Food cho người khác không?",
    answer:
  ...
  {
    question: "Luan Food tính phí giao đồ ăn như thế nào?",
    answer:
