...
import {Close, CreditCard, Done, KeyboardArrowRight, LocalAtmOutlined,} from "@mui/icons-material"
import {
  Box,
  Button,
  CircularProgress,
...
export default function Checkout(props: CheckoutProps) {
  ...
  const cssVoucherDialog = width < 550 ? {
    width: "100vw",
    height: "100vh",
    maxHeight: "unset",
    margin: 0,
  ...
  return (
    <>
      {clientStomp ? <Box>
        ...
        >
          ...
          <DialogContent
            sx={{
              ...
              padding: `${width > 450 ? "20px 24px !important" : "20px 10px !important"}`,
        ...
        <div
          className="bg-white h-[80px] w-screen text-black flex items-center justify-center mt-[80px] font-semibold text-2xl border-t">
          Thanh toán
        </div>
        <div
          style={{
            ...
            {cart.dataStore?.length > 0 ? (
              <>
                ...
                <div className="w-[100%] mb-[100px] bg-white">
                  <div
                    className="px-6 flex flex-row justify-between items-center py-3 border-b-[2px] font-semibold border-gray-300">
                    <p>Ưu đãi</p>{" "}
                    <Button
                ...
                <div
                  ...
                  style={{
                    ...
                    maxHeight: `${width > 600 ? "90px" : "100px"}`
                  }}
                >
                  <div
                    style={{
