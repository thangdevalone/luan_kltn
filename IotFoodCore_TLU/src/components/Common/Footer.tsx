...
const StoreButton: React.FC<StoreButtonProps> = ({path, title, app}) => (
  <Stack className="w-[200px] cursor-pointer rounded-xl px-3.5 py-2 bg-white hover:bg-slate-200" direction="row"
         alignItems="center">
          ...
          <Grid item xs={3}>
            ...
            >
              ...
              <Stack direction="column" spacing={1}>
                ...
                >
                  <Link to={"https://github.com/stark8193"} target="_blank">
                    Tống Đức Luận
                  </Link>
                </Typography>
        ...
        <Grid sx={{mb: "20px"}} container spacing={2}>
          <Grid item xs={8}>
            ...
            >
              ...
              Tặng sao
              <div
                className="flex items-center justify-center text-[var(--color-df-1)] ml-2 bg-gray-300 p-1 w-5 h-5 rounded-[50%] font-semibold">
                {rate ? 1 : 0}
              </div>
            </button>
          ...
          <Grid item xs={4}>
            <p className="text-white">
              Đây là dự án khóa luận tốt nghiệp được phát triển cá nhân. Không nhằm mục đích phục vụ kinh doanh xin cảm
              ơn
            </p>
            <Divider
